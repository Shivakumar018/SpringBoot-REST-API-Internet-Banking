package org.e_Banking.util;

import java.io.UnsupportedEncodingException;

import org.e_Banking.exceptionHandling.FailedToSendOtpException;
...
public class MessageSendingHelper {
	...
	public void sendOtp(String name, String email, int otp) {
		...
		try {
			helper.setTo(email);
			helper.setFrom("ebanking@gmail.com", "eBanking");
	...
	public void sendForgotPasswordOtp(String email, int otp) {
		...
		try {
			...
			String htmlMsg = "<!DOCTYPE html>\r\n"
			        ...
			        + "<head>\r\n"
			        + "    <meta charset=\"UTF-8\">\r\n"
			        + "    <title>eBanking Password Reset</title>\r\n"
			        + "    <style>\r\n"
			        + "        body {\r\n"
			        + "            font-family: 'Segoe UI', Arial, sans-serif;\r\n"
			        + "            background-color: #f4f6f8;\r\n"
			        ...
			        + "        <div class=\"content\">\r\n"
			        + "            <p>Hello <strong>{{name}}</strong>,</p>\r\n"
			        + "            <p>We received a request to reset your password for your <b>eBanking</b> account.</p>\r\n"
			        + "            <p>Please use the following One-Time Password (OTP) to verify your identity and reset your password:</p>\r\n"
			        + "            <div class=\"otp-box\">{{otp}}</div>\r\n"
			        + "            <p>This OTP is valid for the next <b>2 minutes</b>. If you didn’t request a password reset, please ignore this email.</p>\r\n"
			        + "            <p>Thank you,<br><b>The eBanking Team</b></p>\r\n"
			        + "        </div>\r\n"
			        + "        <div class=\"footer\">\r\n"
			        + "            &copy; 2025 eBanking. All rights reserved.\r\n"
			...
			htmlMsg = htmlMsg.replace("{{name}}", email );
			htmlMsg = htmlMsg.replace("{{otp}}", otp + "");
